...
agent performs against a **target** (article, node, or selection), producing a
staged proposal. Actions map to runbooks; targets come from the graph.
...
## Graph & organization
Add Links · Find Related · Categorize · Add Metadata · Deduplicate · Merge ·
