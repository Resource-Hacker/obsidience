...
grouping rather than an executable coordinator Task. The [Observation lifecycle](/Agents/Executive/Architecture/Harness/observations.md)
...
- `related_to` [Real-time Executive](/Agents/Executive/Architecture/Harness/real-time-executive.md) — The speech connection delivers requests to the same ordinary work Tasks as typed Chat.
