...
action: update
agent: Alexandria
base_sha256: ac0094112390d175ae4e899a8aacd15796fa8b96b01076ca8204c41b8c690e2d
proposal: true
proposed_at: '2026-08-27T16:37:21'
reason: The two exact Articles are distinct and not already directly linked. [[Agents/Executive/Architecture/real-time-executive]]
  states that accepted Knowledge in the normal graph is its durable context, while
  [[Agents/Executive/Architecture/llm-wiki-knowledge-pattern--dab5ff0a]] defines that
  accepted graph as the durable LLM-wiki knowledge pattern, so one directional link
  makes the dependency explicit.
rejected_at: '2026-08-27T16:39:01'
rejected_reason: Rollback to the exact pre-request state; this proposal appeared only
  after the rollback restart.
review_class: link
run_id: 6a8e5403ba7b
target: Agents/Executive/Architecture/real-time-executive.md
task: Tasks/link
...
Knowledge in the normal graph maintained under
[[Agents/Executive/Architecture/llm-wiki-knowledge-pattern--dab5ff0a|LLM-wiki knowledge pattern]]
is the durable context; Source archival and pending proposals do not create a
parallel memory store or accepted truth.
