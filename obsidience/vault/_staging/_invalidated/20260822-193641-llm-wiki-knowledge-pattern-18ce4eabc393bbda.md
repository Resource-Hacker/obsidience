...
proposal: true
proposed_at: '2026-08-22T19:36:41'
reason: Redirect the Alexandria `governs` edge from the merged shadow [[Agents/Executive/Subagents/alexandria-curator-role--dcde65f2]]
  to the retained canonical Agent Article [[Agents/Alexandria/Alexandria]] as part
  of the merge; Darwin and Heimdall edges are out of scope and remain untouched.
