...
proposal: true
proposed_at: '2026-08-22T19:35:20'
reason: Redirect inbound `governs` edges from the shadow role charters to the canonical
  Agent Brain Articles as the merge of [[Agents/Executive/Subagents/alexandria-curator-role--dcde65f2]]
  into [[Agents/Alexandria/Alexandria]] removes that shadow; the same decisive special
  case applies to the parallel Darwin and Heimdall shadows.
