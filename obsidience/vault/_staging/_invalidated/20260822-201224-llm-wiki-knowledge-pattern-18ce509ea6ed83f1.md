...
proposal: true
proposed_at: '2026-08-22T20:12:24'
reason: Retarget the `governs` edge in [[Agents/Executive/Architecture/llm-wiki-knowledge-pattern--dab5ff0a]]
  from the duplicate role charter [[Agents/Executive/Subagents/darwin-researcher-role--de1c05ce]]
  to the retained canonical Agent Article [[Agents/Darwin/Darwin]].
target: Agents/Executive/Architecture/llm-wiki-knowledge-pattern--dab5ff0a.md
task: Tasks/merge
