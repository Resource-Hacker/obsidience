...
- The editable Article body ends at `--- End of Article body ---`. Everything after it is generated read-only graph context. Incoming references are not outgoing Article links; never copy that appendix, lifecycle metadata or the end marker into an update.
